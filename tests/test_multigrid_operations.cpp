...
//     std::vector<double> r = multigrid_operations::compute_residual(v, f, h, sigma);
...
//     std::vector<double> coarse_residual = multigrid_operations::restrict_residual(residual);
...
//     std::vector<double> vh = multigrid_operations::prolongate(v2h);
...
//     std::vector<double> coarse = multigrid_operations::restrict_residual(original);

//     // Prolongate coarse back to fine
//     std::vector<double> recovered = multigrid_operations::prolongate(coarse);
