...
void MG::set_smoother_1d(smoother::SmootherType smoother_type) {
    switch (smoother_type) {
        case smoother::SmootherType::J:
            smooth_ = smoother::jacobi_1d;
            break;
...
void MG::set_smoother_2d(smoother::SmootherType smoother_type) {
    switch (smoother_type) {
        case smoother::SmootherType::J:
            smooth_ = smoother::jacobi_2d;
            break;
        case smoother::SmootherType::WJ:
            // smooth_ = smoother::weighted_jacobi;
            break;
