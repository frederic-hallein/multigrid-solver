...
private:
    ...
    double alpha_;
    std::function<void(std::vector<double>&, const std::vector<double>&, unsigned int)> smooth_;
    ...
    void set_smoother_1d(smoother::SmootherType smoother_type);
    void set_smoother_2d(smoother::SmootherType smoother_type);
